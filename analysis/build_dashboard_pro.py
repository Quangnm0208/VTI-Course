...
<div class="app">
 <aside class="side">
   ...
   <div class="foot">Nguồn: Stack Overflow Survey (11.552 dev / 135 quốc gia) + ItViec (1.200 JD, 28/05/2026). Số liệu thật, không bịa.</div>
 </aside>
 <main class="main">
   <div class="head">
...
function renderVietnam(){
  ...
  el.innerHTML=`<div class="kpis" style="grid-template-columns:repeat(4,1fr)">
    <div class="kpi"><div class="k">Tin tuyển dụng</div><div class="v">1.200</div><div class="s">ItViec · 28/05/2026</div></div>
